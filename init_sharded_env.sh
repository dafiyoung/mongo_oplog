# Andrew Erlichson
# 11gen
# added support for mongo 3.4 by dafiyoung
# mkdir /data
# chown -R <>:<> /data
...
rs.initiate(config)
EOF
# now start 3 config servers as replSet cfg1
mkdir -p /data/config/config-a /data/config/config-b /data/config/config-c
mongod --logpath "cfg-a.log" --dbpath /data/config/config-a --port 57040 --fork --configsvr --smallfiles --replSet cfg1
mongod --logpath "cfg-b.log" --dbpath /data/config/config-b --port 57041 --fork --configsvr --smallfiles --replSet cfg1
mongod --logpath "cfg-c.log" --dbpath /data/config/config-c --port 57042 --fork --configsvr --smallfiles --replSet cfg1
sleep 5
...
mongos --logpath "mongos-1.log" --configdb cfg1/localhost:57040,localhost:57041,localhost:57042 --fork
